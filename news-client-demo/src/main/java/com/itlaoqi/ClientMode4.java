...
public class ClientMode4 {
    ...
    public static void main(String[] args) {
        ClientMode4 client = new ClientMode4();
    ...
    public void createPhone() throws InterruptedException {
        ...
        StreamObserver<SmsProto.PhoneNumberRequest> requestObserver = asyncStub.createAndSendSms(responseObserver);
